/*======================================================================
Restore AdventureWorksDW2025 範例資料庫
------------------------------------
1. 下載 AdventureWorksDW2025 資料庫備份檔案
...
3. 在 VM 環境中建立資料庫檔案存放路徑 F:\SQLServer\Datafiles\ 目錄
   (也可以放在其他位置, 若使用其他位置, 請自行修改程式碼以符合對應的檔案位置)
4. 執行下列程式碼, 將 AdventureWorksDW2025 範例資料庫還原
...
if db_id('AdventureWorksDW2025') is null
begin
    restore database AdventureWorksDW2025
    from disk = 'C:\Temp\AdventureWorksDW2025.bak'
    with 
    move 'AdventureWorksDW' to 'F:\SQLServer\Datafiles\AdventureWorksDW2025.mdf',
    move 'AdventureWorksDW_log' to 'F:\SQLServer\Datafiles\AdventureWorksDW2025_log.ldf',
    recovery, replace, stats = 10;
end
else
begin
    print N'資料庫 AdventureWorksDW2025 已存在!';
end
go
